...
theorem cleanupPile_base (pile : UInt32) (g : Globals) (p : SolverPosType)
  ...
  sorry -- TODO: replace with a from-scratch proof using cleanupPile_nonempty_eq +
         -- cleanupRunResult_eq + the modular preCleanupPile_*/kingMove_* lemmas
         -- (PileBase/PileMerged/SuitClean/hash_def/usedSpace_def), per the
         -- redesigned PileMerged.flute_maximal (equality)/PileBase.flute_not_aces
         -- (Nat inequality) invariants. Old monolithic body removed since it
         -- predated both redesigns and was already 8-sorry incomplete.
